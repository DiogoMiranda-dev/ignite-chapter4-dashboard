...
export function Pagination({
    ...
    return (
        ...
        >
            <Box>
                <strong>{ currentPage == 1 ? 1 : (registersPerPage*currentPage) - (registersPerPage - 1)}</strong> -  <strong>{currentPage * registersPerPage}</strong> de  <strong>{totalCountOfRegisters}</strong>
            </Box>
